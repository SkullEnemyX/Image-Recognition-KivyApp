    ...
    def check(self, *args):
        ...
        if 'wikipedia' in website:
            ...
            def infobox():
                ...
                if(table==None):
                    self.ids.view.text= wikipedia.summary(str(self.ids.pink.text), sentences=2)
                    ...
                    with open("Output.txt", "r+") as fob:
                        self.ids.view.text = fob.read()

            infobox()
            self.ids.img1.source = research_later+"1"+".jpg"
            self.ids.img1.reload()
            self.ids.img2.source = research_later+"2"+".jpg"
            self.ids.img2.size_hint = (0.5,0.5)
            self.ids.img2.pos_hint = {'center_x':.65, 'center_y':.65}
